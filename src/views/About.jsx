...
export function About({ listToken }) {
	return (
		<div className="h-screen w-screen flex flex-col pl-20 pr-20 pb-20">
			...
			<img
				src="img/limey-app-add-item.png"
				className="sm:max-w-sm max-sm:max-w-xs self-center"
				alt="adding items to Limey"
			/>
			<h2 className="mb-4 text-xl font-bold self-center">
				Add groceries to your list
			</h2>
			<p className="mb-10 md:w-[40%] self-center">
			...
			<img
				src="img/limey-app-checkoff-items.png"
				className="sm:max-w-sm max-sm:max-w-xs self-center"
				alt="checking off purchased items on Limey"
			/>
			<h2 className="mb-4 text-xl font-bold self-center">
			...
			<img
				src="img/limey-app-purchase-date.png"
				className="sm:max-w-sm max-sm:max-w-xs self-center"
				alt="future purchase date for item on Limey"
			/>
			<h2 className="mb-4 text-xl font-bold self-center">
				Limey predicts your purchases
			</h2>
			<p className="mb-10 mb-10 md:w-[40%] self-center">
			...
			<img
				src="img/limey-app-share-list.png"
				className="sm:max-w-sm max-sm:max-w-xs self-center"
				alt="sharing list on Limey"
			/>
			<h2 className="mb-4 text-xl font-bold self-center">
				Share your list with others!
			</h2>
			<p className="mb-1 mb-10 md:w-[40%] self-center">
